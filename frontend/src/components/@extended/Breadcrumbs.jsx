  ...
  if (main && main.type === 'collapse' && !main.breadcrumbs) {
    ...
    mainContent = (
      <Typography
        ...
        variant={customLocation === main.url ? 'subtitle1' : 'h6'}
        sx={{ textDecoration: 'none' }}
        color={customLocation === main.url ? 'text.primary' : 'text.secondary'}
      >
          ...
          >
            <Grid>
              <MuiBreadcrumbs aria-label="breadcrumb" maxItems={maxItems || 8} separator={separatorIcon}>
                {/* Remove Home if not necessary, Keeping it for consistency */}
          ...
          {links?.map((link, index) => {
            ...
            return (
              <Typography
                ...
                variant={index === links?.length - 1 ? 'subtitle1' : 'h6'}
                sx={{ textDecoration: 'none' }}
                color={index === links?.length - 1 ? 'text.primary' : 'text.secondary'}
              >
